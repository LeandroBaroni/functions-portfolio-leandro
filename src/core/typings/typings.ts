 ...
 */
export type AddDocument<T extends BaseModel> = WithFieldValue<
 ...
 * @template T - Tipo que estende Model
 */
export type SetDocument<T extends BaseModel> = WithFieldValue<
  Omit<T, 'id' | 'createdAt' | 'updatedAt'>
> &
  Pick<T, 'id'>;
 ...
 * @template T - Tipo que estende Model
 */
export type UpdateDocument<T extends BaseModel> = PartialWithFieldValue<
  Omit<T, 'id' | 'createdAt' | 'updatedAt'>
> &
  Pick<T, 'id'>;
 ...
 * @template T - Tipo que estende Model
 */
export type FirebaseWhere<T extends BaseModel> = [
  keyof T,
  WhereFilterOp,
  unknown,
];
